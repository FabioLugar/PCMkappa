...
#' @export
PCMParentClasses.OUkappa__Global_X0__NonNegative_kappa__Symmetric_WithNonNegativeDiagonal_H__Theta__UpperTriangularWithDiagonal_WithNonNegativeDiagonal_Fixed_Sigma_x__Omitted_Sigmae_x <- function(model) c("OUkappa", "OU", "GaussianPCM", "PCM", "_Transformable")

#' @export
PCMSpecify.OUkappa__Global_X0__NonNegative_kappa__Symmetric_WithNonNegativeDiagonal_H__Theta__UpperTriangularWithDiagonal_WithNonNegativeDiagonal_Fixed_Sigma_x__Omitted_Sigmae_x <- function(model, ...) {
spec <- list(
X0 = structure(0.0, class = c("VectorParameter", "_Global"),
description = c("trait values at the root")),
kappa = structure(0.0, class = c("ScalarParameter", "_NonNegative"),
description = c("proportionality parameter")),
H = structure(0.0, class = c("MatrixParameter", "_Symmetric", "_WithNonNegativeDiagonal"),
description = c("adaptation rate matrix")),
Theta = structure(0.0, class = c("VectorParameter"),
description = c("long-term optimum")),
Sigma_x = structure(0.0, class = c("MatrixParameter", "_UpperTriangularWithDiagonal", "_WithNonNegativeDiagonal", "_Fixed"),
